...
clause in your main scripts, and keep its contents to a minimum. This facilitates testing and code reuse. For more information, see: link:++https://docs.python.org/3/library/__main__.html++[] and 
