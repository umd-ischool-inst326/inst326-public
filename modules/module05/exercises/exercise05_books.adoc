...
== Background
For this exercise we are going to write a function that will create an index for words in two different books. Creating this kind of solution could allow users in the future to find word usage across differnet books and compare usage over time. 
