...
\begin{itemize}
	...
	\item Python: The Python interpreter (version 3), freely available from \href{https://www.python.org/downloads}{https://www.python.org/downloads}.*
	\item Code Editor: An advanced text editor (such as Sublime Text, Notepad++, or BBEdit) and/or an integrated development environment (such as VSCode, Eclipse, or PyCharm).*
